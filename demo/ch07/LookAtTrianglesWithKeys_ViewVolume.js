...
function main() {
  ...
  // Get the storage locations of u_ViewMatrix and u_ProjMatrix variables 获取u_viewMatrix和u_ProjMatrix的存储地址
  ...
  // Create the matrix to specify the viewing volume and pass it to u_ProjMatrix 创建指定可视空间的矩阵并传给u_ProjMatrix变量
