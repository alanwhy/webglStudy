...
function main() {
  ...
  // Pass the model, view, and projection matrix to the uniform variable respectively 将模型矩阵、视图矩阵和投影矩阵传给相应的uniform变量
  ...
  gl.drawArrays(gl.TRIANGLES, 0, n);   // Draw the triangles 绘制右侧的一组三角形
  ...
  gl.drawArrays(gl.TRIANGLES, 0, n);   // Draw the triangles 绘制左侧的一组三角形
}
