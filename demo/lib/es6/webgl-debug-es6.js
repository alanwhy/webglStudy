...
export default class WebGLDebugUtils {
  ...
  makeDebugContext(ctx, opt_onErrorFunc) {
    this.init(ctx);
    opt_onErrorFunc = opt_onErrorFunc || (err, functionName, args)=> {
  ...
  makeLostContextSimulatingContext(ctx) {
    ...
    wrapper_.registerOnContextLostListener = (listener) => {
      onLost_ = wrapEvent(listener);
    };

    wrapper_.registerOnContextRestoredListener = (listener) => {
      if (contextLost_) {
